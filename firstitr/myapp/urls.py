...
from .views import FetchDetailsView, FetchSingleDetailsView, FetchGraphDataView, CacheManagementView, FetchMultipleRunsView

urlpatterns = [
    path('fetch-details/', FetchDetailsView.as_view(), name='fetch_details'),
    path('fetch-single-details/', FetchSingleDetailsView.as_view(), name='fetch_single_details'),
